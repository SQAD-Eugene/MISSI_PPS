...
public class missi_pps_DPS_PO_Staff {
...
//        driver.get("https://missipps.psa.gov.ph/dps/login");
        driver.get("https://sqad-test.psa.gov.ph/cawi/public/");
//        driver.get("http://192.168.26.104:81/public/login");
    ...
    public void Login() throws InterruptedException {
        ...
        int iteration = 1;
        for (DataSet credentials : dataset.test_credentialsPO_Staff) {
    ...
    public static void view_workload() throws InterruptedException {
    ...
    public void cawi_registration() throws InterruptedException {
        ...
        Cawi_Registration.txt_ECN.sendKeys(dataset.ECN_PO_Staff);
        Cawi_Registration.btn_search.click();
        sleep(2000);
        Cawi_Registration.btn_edit.click(); //*[@id="__BVID__55"]/tbody/tr/td[4]/div/button[1]
        ...
        if (Objects.equals(C_Address, "killazawa@yahoo.com")) {
...
//        Package_Element.Cawi_Registration.btn_save.click();
//        sleep(10000);
        Cawi_Registration.btn_close.click();
    }

    @Test(priority = 6, testName = "workload_referral", enabled = true )
    public void workload_referral() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(Workload_Referral.lbl_Workload_Referral));
        ...
        Workload_Referral.txt_Search.sendKeys(dataset.ECN_PO_Staff);
...
//        executor.executeScript("window.scrollBy(0, 500);");
    ...
    @Test(priority = 9, testName = "data_validation", enabled = true )
    ...
    @Test(priority = 10, testName = "reports", enabled = true)
    public void reports() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOf(Reports.lbl_Reports));
    ...
    @Test(priority = 11, testName = "view_data" , enabled = true)
    ...
    @Test(priority = 12, testName = "list_of_sample_estab" , enabled = true)
    public void list_of_sample_estab() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOf(List_of_sample_estab.lbl_Record_Management));
        List_of_sample_estab.lbl_Record_Management.click();
    ...
    @Test(priority = 13, testName = "tracking_changes_data_entry", enabled = true)
    public void tracking_changes_data_entry() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOf(Tracking_changes_data_entry.lbl_Record_Management));
        Tracking_changes_data_entry.lbl_Record_Management.click();
    ...
    @Test(priority = 14, testName = "utilities", enabled = true)
    public void utilities() throws InterruptedException {
        ...
        Utilities.txt_Fname_PO.sendKeys("sample FName");
        Utilities.txt_Mname_PO.clear();
        Utilities.txt_Mname_PO.sendKeys("sample MName");
        Utilities.txt_Lname_PO.clear();
        Utilities.txt_Lname_PO.sendKeys("sample LName");

        Utilities.btn_cancel2.click();
